            ...
            <div style={{ marginTop: '12px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button
                  ...
                  style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '10px', borderRadius: '12px', border: '2px solid #DADCE0', background: '#fff', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
                >
                ...
                <button
                  ...
                  style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '10px', borderRadius: '12px', border: '2px solid #000', background: '#000', color: '#fff', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
                >
                ...
                <button
                  ...
                  style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '10px', borderRadius: '12px', border: '2px solid #1877F2', background: '#1877F2', color: '#fff', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
                >
