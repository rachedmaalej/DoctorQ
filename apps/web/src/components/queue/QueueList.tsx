  ...
  if (queue.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-8 sm:p-12 text-center">
        ...
        <p className="text-gray-500 text-base sm:text-lg mb-2">{t('queue.noPatients')}</p>
        <p className="text-gray-400 text-sm">{t('queue.emptyHint', 'Share your check-in QR code or add a patient manually to get started.')}</p>
      </div>
    );
  }
