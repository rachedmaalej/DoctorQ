    ...
    <>
      ...
      <div className={`bs-right-panel ${isOpen ? 'open' : ''}`} style={{ zIndex: zIndex ?? 95 }}>
        ...
        <div className="bs-panel-header">
          ...
          <span className="bs-panel-title">{t('settingsBs.teamAccess.title')}</span>
        </div>
        ...
        <div className="bs-panel-body">
            <>
              ...
              >
                {t('settingsBs.teamAccess.doctors')}
                {!loading && doctors.length > 0 && (
                  <span style={{
                    ...
                    {t('settingsBs.teamAccess.doctorCount', { count: doctors.length })}
                  </span>
                )}
              </div>
              ...
              >
                {loading ? (
                  <div style={{
                    ...
                    {t('settingsBs.teamAccess.loading')}
                  </div>
                ) : doctors.length === 0 ? (
                  /* Empty state */
                  <div style={{ padding: '40px 20px', textAlign: 'center' }}>
                    ...
                    <div style={{
                      ...
                      {t('settingsBs.teamAccess.noDoctors')}
                    </div>
                    <div style={{
                      fontSize: 13,
                      color: '#9E9B90',
                      ...
                      {t('settingsBs.teamAccess.noDoctorsDesc')}
                    </div>
                  </div>
                ) : (
                  /* Doctor cards */
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          }} title={doctor.isActive ? t('settingsBs.teamAccess.active') : t('settingsBs.teamAccess.inactive')} />
                        ...
                        >
                          ...
                          <div style={{
                            ...
                            <span style={{ fontSize: 13, color: '#1A1A1A', fontWeight: 500 }}>
                              {t('settingsBs.teamAccess.active')}
                            </span>
                            <div
                              style={{
                                width: 44,
                          ...
                          <div style={{
                            ...
                            <span style={{ fontSize: 13, color: '#1A1A1A', fontWeight: 500 }}>
                              {t('settingsBs.teamAccess.consultDuration')}
                            </span>
                            <div style={{
                              display: 'flex',
                              alignItems: 'center',
                          ...
                          >
                            ...
                            {t('settingsBs.teamAccess.deleteDoctor')}
                          </button>
                        </div>
                      </div>
                    );
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {t('settingsBs.teamAccess.addDoctor')}
                </div>
                ...
                <div style={{ marginBottom: 10 }}>
                  <label style={{
                    ...
                    {t('settingsBs.teamAccess.fullName')}
                  </label>
                  <input
                    type="text"
                    placeholder={t('settingsBs.teamAccess.namePlaceholder')}
                    value={newName}
                ...
                <div style={{ marginBottom: 10 }}>
                  <label style={{
                    ...
                    {t('settingsBs.teamAccess.specialty')}
                  </label>
                  <select
                    value={newSpecialty}
                  ...
                  >
                    <option value="" disabled>{t('settingsBs.teamAccess.selectSpecialty')}</option>
                    {SPECIALTIES.map(s => (
                ...
                >
                  ...
                  {doctors.length === 0 ? t('settingsBs.teamAccess.addFirstDoctor') : t('settingsBs.teamAccess.addButton')}
                </button>
              </div>
            </>
        </div>
          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                {t('settingsBs.teamAccess.confirmDelete')}
              </div>
              <div style={{
                fontSize: 13,
                color: '#6B6960',
                ...
                {t('settingsBs.teamAccess.confirmDeleteDesc', { name: deletingDoctor.name })}
              </div>
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                >
                  {t('settingsBs.teamAccess.cancel')}
                </button>
                <button
                ...
                >
                  {deleteLoading ? t('settingsBs.teamAccess.deleting') : t('settingsBs.teamAccess.delete')}
                </button>
              </div>
            </div>
          </div>
