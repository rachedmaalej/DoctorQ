...
/**
 * Screen 3: Sign-up — Option B (SSO First).
 * Primary CTAs: Google / Apple / Facebook.
 * Secondary: inline email + password + clinic form revealed on tap.
 */
export default function SignUpScreen({ step, specialty, onAdvance }: SignUpScreenProps) {
  ...
  }, [canSubmit, email, password, clinicName, specialty, checkAuth, setClinicInfo, onAdvance]);
    ...
    >
      ...
      <ContentCard>
        <div className="flex flex-col overflow-y-auto" style={{ maxHeight: showEmailForm ? '65vh' : undefined }}>
          ...
          <p
            className="text-[11px] leading-relaxed mb-[10px]"
          ...
          {/* Trust signal */}
          <p
            className="text-center text-[11px] mt-[8px] flex items-center justify-center gap-1"
            style={{ fontFamily: 'var(--ob-font)', color: 'var(--ob-brand-subtle)' }}
          >
            <span>&#128274;</span> {copy.trust}
          </p>
          ...
          <button
            ...
            className="block mx-auto mt-[5px] text-[12px] underline hover:no-underline transition-all"
